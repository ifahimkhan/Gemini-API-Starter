package com.c035.sukhada_assignment1;
...
import com.c035.sukhada_assignment1.R;
import com.c035.sukhada_assignment1.database.ChatDatabase;
import com.c035.sukhada_assignment1.database.ChatMessage;
        ...
        new Thread(() -> {
            try {
                ...
                GenerateContentResponse response = BuildersKt.runBlocking(
                        ...
                        (scope, cont) -> generativeModel.generateContent(contextPrompt, cont)
                );
